...
<h2 id="sayfalar" tabindex="-1"><a class="header-anchor" href="#sayfalar"><span>Sayfalar</span></a></h2>
...
<h2 id="yapılandırma" tabindex="-1"><a class="header-anchor" href="#yapılandırma"><span>Yapılandırma</span></a></h2>
...
<h2 id="duzen-ve-ozellestirme" tabindex="-1"><a class="header-anchor" href="#duzen-ve-ozellestirme"><span>Düzen ve Özelleştirme</span></a></h2>
